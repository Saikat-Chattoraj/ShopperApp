      ...
      <div className="w-full flex flex-col mt-8">
        ...
        >
          <div className="rounded-md shadow-lg">
            ...
            <div className="px-2 text-sm font-bold">Taneira Sarees</div>
          ...
          <div className="rounded-md shadow-lg">
            ...
            <div className="px-2 text-sm font-bold">BIBA Kurtas</div>
            <div className="flex flex-row px-2">
              <div className="bg-black h-4 w-4 rounded-full mr-2 shadow-md " />
              <div className="bg-blue-700 h-4 w-4 rounded-full mr-2 shadow-md" />
              <div className="bg-white h-4 w-4 rounded-full mr-2 shadow-md" />
          ...
          <div className="rounded-md shadow-lg">
            ...
            <div className="px-2 text-sm font-bold">Adwitiya Jewellers</div>
            <div className="flex flex-row px-2">
              <div className="bg-black h-4 w-4 rounded-full mr-2 shadow-md " />
              <div className="bg-blue-700 h-4 w-4 rounded-full mr-2 shadow-md" />
              <div className="bg-white h-4 w-4 rounded-full mr-2 shadow-md" />
          ...
          <div className="rounded-md shadow-lg">
            ...
            <div className="px-2 text-sm font-bold">Lingerie</div>
            <div className="flex flex-row px-2">
              <div className="bg-black h-4 w-4 rounded-full mr-2 shadow-md " />
              <div className="bg-blue-700 h-4 w-4 rounded-full mr-2 shadow-md" />
              <div className="bg-white h-4 w-4 rounded-full mr-2 shadow-md" />
          ...
          <div className="rounded-md shadow-lg">
            ...
            <div className="px-2 text-sm font-bold">Bath Essentials</div>
            <div className="flex flex-row px-2">
              <div className="bg-black h-4 w-4 rounded-full mr-2 shadow-md " />
              <div className="bg-blue-700 h-4 w-4 rounded-full mr-2 shadow-md" />
              <div className="bg-white h-4 w-4 rounded-full mr-2 shadow-md" />
